...
export const fetchByBreed = async (breed) => {
  ...
  const request = await fetch(process.env.URL + "/api/images/breed", {
    cache: "no-store",
    method: "POST",
    headers: {
...
export const fetchAllImagesbyBreed = async (breed) => {
  const request = await fetch(process.env.URL + "/api/images/breeds", {
    cache: "force-cache",
    method: "POST",
    header: {
      "Content-Type": "application/json",
...
export const fetchFacts = async (number) => {
  const request = await fetch(process.env.URL + "/api/jokes", {
    cache: "no-store",
    method: "POST",
    headers: {
      "Content-Type": "application/json",
